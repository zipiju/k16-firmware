...
SOURCEFILES_QUOTED_IF_SPACED=../USB/usb_device.c ../USB/usb_hal_pic24.c ../USB/usb_function_generic.c ../usb_descriptors.c asic.c i2c.c klondike.c main.c
...
# Source Files
SOURCEFILES=../USB/usb_device.c ../USB/usb_hal_pic24.c ../USB/usb_function_generic.c ../usb_descriptors.c asic.c i2c.c klondike.c main.c
...
${OBJECTDIR}/_ext/1360907413/usb_device.p1: ../USB/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360907413/usb_device.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=all,+asm,-asmfile,+speed,-space,-debug --addrqual=require --mode=pro -N100 -I".." -I"../Include" --warn=9 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"    -o${OBJECTDIR}/_ext/1360907413/usb_device.p1  ../USB/usb_device.c 
...
${OBJECTDIR}/_ext/1360907413/usb_hal_pic24.p1: ../USB/usb_hal_pic24.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360907413/usb_hal_pic24.p1 
...
${OBJECTDIR}/_ext/1360907413/usb_function_generic.p1: ../USB/usb_function_generic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360907413/usb_function_generic.p1 
...
${OBJECTDIR}/_ext/1360907413/usb_device.p1: ../USB/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360907413/usb_device.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1360907413/usb_device.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=24 --float=24 --opt=all,+asm,-asmfile,+speed,-space,-debug --addrqual=require --mode=pro -N100 -I".." -I"../Include" --warn=9 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"    -o${OBJECTDIR}/_ext/1360907413/usb_device.p1  ../USB/usb_device.c 
	@-${MV} ${OBJECTDIR}/_ext/1360907413/usb_device.d ${OBJECTDIR}/_ext/1360907413/usb_device.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1360907413/usb_device.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../rm18F14K50.lkr
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=all,+asm,-asmfile,+speed,-space,-debug --addrqual=require --mode=pro -N100 -I".." -I"../Include" --warn=9 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"        -odist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../rm18F14K50.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=all,+asm,-asmfile,+speed,-space,-debug --addrqual=require --mode=pro -N100 -I".." -I"../Include" --warn=9 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"     -odist/${CND_CONF}/${IMAGE_TYPE}/Klondike.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
